...
app.get("/list-blog",async (req,res) => {
    const data= await db.todos.findAll() //select * from todos
    res.render("pages/list-blog",{ todos: data }) //rendering the get-todo.ejs file and passing the todos data to it
})
